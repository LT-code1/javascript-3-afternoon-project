...
function numberGroups({a,b,c}){
  let lengthA = a.length; console.log(a.length);  
  let lengthB = b.length; console.log(b.length);
  let lengthC = c.length; console.log(c.length);
  if(lengthA>lengthB && lengthA>lengthC){return a}
  else if(lengthB>lengthA && lengthB>lengthC){return b}
  else {return c};
