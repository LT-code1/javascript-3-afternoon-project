...
*/
let evenNumbers  = mixedNumbers.filter(function(element,i,arr){
  return element%2===0;
 });
...
//Code Here
let totalPopulation = populations.reduce(function(total,element,i,arr){//  = populations.reduce(/* Provide Your Callback Here */)
...
/*
  Use a higher order method to get all the order totals after adding in the sales tax. Your answer should be an array of
